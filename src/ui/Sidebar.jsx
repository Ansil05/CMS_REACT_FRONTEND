  ...
  const getMenuItems = () => {
    const menus = {
      admin: [
        ...
        { path: '/app/admin/users', icon: FaUsers, label: 'Users' },
        { path: '/app/admin/doctors', icon: FaUserMd, label: 'Doctors' },
        { path: '/app/admin/reports', icon: FaChartBar, label: 'Reports' },
        { path: '/app/admin/settings', icon: FaCog, label: 'Settings' },
      ],
      doctor: [
        { path: '/app/doctor', icon: FaHome, label: 'Dashboard' },
        { path: '/app/doctor/appointments', icon: FaCalendar, label: 'Appointments' },
        { path: '/app/doctor/patients', icon: FaUsers, label: 'Patients' },
        { path: '/app/doctor/prescriptions', icon: FaPills, label: 'Prescriptions' },
      ],
      receptionist: [
